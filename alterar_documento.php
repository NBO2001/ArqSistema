...
$valor_pesquisa = filter_input(INPUT_POST,'idrecurera',FILTER_SANITIZE_STRING);
...
$sele=strtoupper($sele);
$vl ="UPDATE Ko SET nome = '$descricao', tipo_doc = '$classfi', ano_doc = '$ano', fase_con = '$fase_con', fase_in = '$fase_in', destin_fin = '$destin_fin', ano_ex = $ano_ex, class_doc = '$sele' WHERE Ko.id =".$valor_pesquisa;
